...
COMPLAINT_BY_CHRONIC = {
    "Hypertension":          ["最近常頭暈", "血壓追蹤", "頭痛 1 週", "自測 BP 偏高"],
    "Type 2 Diabetes":       ["血糖追蹤", "口渴頻尿增加", "腳麻 2 週", "HbA1c 複檢"],
    "Hyperlipidemia":        ["健檢追蹤", "膽固醇複檢", "藥物副作用評估"],
    "Asthma":                ["氣喘發作 2 天", "夜咳", "胸悶 喘", "預防性追蹤"],
    "COPD":                  ["喘 加重", "痰量增加", "COPD 追蹤"],
    "Osteoarthritis":        ["膝痛 加重", "關節僵硬", "止痛藥追蹤"],
    "Atrial Fibrillation":   ["心悸 1 週", "Holter 報告追蹤", "抗凝血藥追蹤"],
    "CKD Stage 3":           ["腎功能追蹤", "水腫 1 週", "Cr 複檢"],
    "Hypothyroidism":        ["疲倦 1 個月", "TSH 追蹤", "體重變化評估"],
    "Anxiety Disorder":      ["焦慮 加重", "睡眠問題", "心悸 evaluation"],
    "Migraine":              ["偏頭痛 3 天", "頭痛追蹤"],
    "GERD":                  ["胃酸逆流", "胸悶 餐後加重"],
    "BPH":                   ["夜尿增加", "排尿困難"],
    "Heart Failure":         ["喘 加重", "下肢水腫", "夜間呼吸困難"],
    "Dementia":              ["健忘加重 (家屬陳述)", "認知評估追蹤"],
    "Depression":            ["情緒低落 1 月", "睡眠問題"],
    "Gout":                  ["腳痛 急性發作", "尿酸追蹤"],
    "Osteoporosis":          ["骨密度追蹤", "腰背痛"],
}
...
# 健康 / 無 chronic 病人的 generic visit
GENERIC_COMPLAINTS = [
    "上呼吸道感染 3 天", "腸胃炎 一天", "皮膚紅疹", "腰痛", "頭痛",
    "輕度感冒症狀", "例行健康檢查", "Annual physical", "輕度過敏症狀",
]
GENERIC_DIAGNOSES = [
    "急性上呼吸道感染", "急性腸胃炎", "接觸性皮膚炎", "肌肉拉傷",
    "緊張型頭痛", "感冒 (URTI)", "健康檢查 (無異常)", "過敏性鼻炎",
]
